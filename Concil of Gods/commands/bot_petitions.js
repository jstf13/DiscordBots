    ...
    switch (comand) {
      ...
      case "embedwelcome-english":
        const embedDatos7 = new Discord.MessageEmbed()
          ...
          .setColor(0x00ae86)
          .setFooter(
            "This is an importan message from the gods.",
            client.user.avatarURL()
          )
          .setTimestamp()
          .addField(
      ...
      case "embedlenguage":
        const embedDatos3 = new Discord.MessageEmbed()
          ...
          .addField(
            "❗IMPORTANT",
            "You can react with both flags and you will have access to both channels of each theme."
          )
          .addField(
            "❗IMPORTANTE",
            "Puedes reaccionar con ambas banderas y tendrás acceso a ambos canales de cada tematica."
          );
      ...
      case "embedfaq-english":
        const embedDatos4 = new Discord.MessageEmbed()
          ...
          .addField(
            ...
            "The mint date will be on February 9."
          )
          .addField(
